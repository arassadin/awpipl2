/*
    ...
    $Source: /home/cvs/awp/imageproc/awpipl-v2/src/awpthreshold.c,v $
    $Revision: 1.18 $
...
static AWPRESULT _awpMakeBinaryBYTE(const awpImage* src, awpImage* dst, const AWPDOUBLE sThreshold, 
									const LONG lOptions, awpRect r, AWPDOUBLE MaxValue, AWPDOUBLE MinValue)
{
...
AWPRESULT awpMakeBinary(const awpImage* pImage, awpImage** ppBinImage, const AWPDOUBLE sThreshold, const LONG lOptions, 
...
AWPRESULT __awpMakeBinary(const awpImage* pImage, awpImage** ppBinImage, const AWPDOUBLE sThreshold, const LONG lOptions)
{
    awpImage* pTempImage;
    AWPINT iImageType;
    AWPINT iIndex;
    ...
    case AWP_SHORT:  pSrcBuf  = (SHORT*)  pImage->pPixels;
        pTempBuf = (SHORT*)  pTempImage->pPixels; break;
    ...
    if(lOptions == AWP_BINARY)
        for(iIndex = 0; iIndex < pImage->sSizeX*pImage->sSizeY*pImage->bChannels; ++iIndex)
        {
            ...
            case AWP_SHORT:  ((SHORT*) pTempBuf)[iIndex] = (((SHORT*) pSrcBuf)[iIndex] > sThreshold)?255:0; break;
        ...
        for(iIndex = 0; iIndex < pImage->sSizeX*pImage->sSizeY*pImage->bChannels; ++iIndex)
        {
            ...
            case AWP_SHORT:  ((SHORT*) pTempBuf)[iIndex] = (((SHORT*) pSrcBuf)[iIndex] > sThreshold)?0:255; break;
