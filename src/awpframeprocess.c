...
static AWPRESULT _awpMltImages(const awpImage *pImageSrc1, awpImage *pImageSrc2, awpImage **ppImageDst, const long lWhere)
{
    void *pData1;
    void *pData2;
    void *pData3;
    ...
    switch(iImageType)
            {
                ...
                case AWP_SHORT:  pData1 = (SHORT*)pImageSrc1->pPixels;
                                 pData2 = (SHORT*)pImageSrc2->pPixels;   break;  
    ...
    for(dwIndex = 0; dwIndex < (DWORD)pImageSrc1->sSizeX*pImageSrc1->sSizeY*pImageSrc1->bChannels ; ++dwIndex)
    {
            switch(iImageType)
            {
                case AWP_BYTE:   dSrc1 = ((AWPBYTE*)pData1)[dwIndex];
                                 dSrc2 = ((AWPBYTE*)pData2)[dwIndex]; break;
                case AWP_SHORT:  dSrc1 = ((SHORT*)pData1)[dwIndex];
                                 dSrc2 = ((SHORT*)pData2)[dwIndex]; break;
